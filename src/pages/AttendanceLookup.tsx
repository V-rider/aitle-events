  ...
  return (
    <div className="page-shell bg-white">
      <header className="sticky top-0 z-30 border-b bg-white/95 backdrop-blur no-print">
        <div className="container mx-auto flex max-w-3xl items-center justify-between gap-4 px-4 py-3.5">
          <Link to="/" className="flex items-center">
            <img src="/aitle-logo.png" alt="AiTLE" className="h-8 w-auto" />
          </Link>
          <Link
            to="/"
      ...
      <main className="container mx-auto max-w-2xl px-4 pb-8 pt-10 sm:pt-14">
        ...
        <form onSubmit={search} className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-stretch">
          ...
          <Button
            type="submit"
            disabled={loading}
            className="h-12 shrink-0 rounded-lg bg-[#0f2f6b] px-6 text-sm font-medium hover:bg-[#0c2758] sm:min-w-[7.5rem]"
          >
        ...
        <div className="mt-8">
          {records === null ? (
            <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border px-6 py-14 text-center sm:py-16">
              <Search className="mb-4 h-14 w-14 text-muted-foreground/25" strokeWidth={1.25} aria-hidden />
            ...
            <div className="space-y-3">
              {records.map((r) => (
                <div
                  ...
                  className="rounded-xl border border-border/80 bg-white p-4 sm:p-5"
                >
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    <div className="min-w-0">
                      <div className="font-semibold leading-snug text-foreground">{r.eventTitle}</div>
